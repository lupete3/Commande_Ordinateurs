<?php 
  ...
  $list_ventes = $model->getTransfertsAll(); 

  if (isset($_GET['btnAffiche'])) {
    $debut = $_GET['from'];
    $fin = $_GET['to'];

    $list_ventes = $model->getTransfertsAllSearch($debut,$fin); 
  ...
  <div class="container " style="margin-bottom: 100px;">
    <div class="row">
      ...
      <div class="col-md-12 text-center" >
        ...
        <h2 class="text-center" style="margin-top: 30px">FICHE DE TRANSFERT DE PRODUIT VERS LE SHOP</h2>
