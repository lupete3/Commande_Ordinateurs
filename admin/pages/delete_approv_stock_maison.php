<?php 
  ...
  if (isset($_POST['id'])){
      ...
      if (!empty($_POST['id']) ) {
        ...
        $data_approv = $model->getApprovProdMaisonSingle($id);
        ...
        if ($delete_data = $model->deleteApprovProdMaison($id)) {

           $uptdate_data = $model->updateQteProdMaison($id_product,$qte,$action='supp');
