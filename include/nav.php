  ...
  <div class="panel panel-default sidebar-menu">
    ...
    <div class="panel-body">
      <ul class="nav nav-pills flex-column text-sm">
        <li class="nav-item"><a href="client_espace.php" class="nav-link active"><i class="fa fa-list"></i> Mes Commandes</a></li>
        <li class="nav-item"><a href="customer-account.html" class="nav-link"><i class="fa fa-user"></i> My account</a></li>
        <li class="nav-item"><a href="produits_favoris.php" class="nav-link"><i class="fa fa-heart"></i> Mes Produits Préferés</a></li>
